...
public class Main extends JFrame {
	...
	private JButton grafikrechnerBtn;
	...
	private void initComponents() {
		...
		grafikrechnerBtn = new JButton("Grafikrechner");
		styleButton(grafikrechnerBtn, new Color(0, 150, 120));
	...
	private void setupListeners() {
		...
		wurzelBtn.addActionListener(e -> {
			...
			baumBtn.addActionListener(e -> zeigeBaum());
		...
		grafikrechnerBtn.addActionListener(e -> starteGrafikrechner());
		}
		...
		private JButton[] extendedList() {
			return new JButton[] { tempumrechBtn, einheitBtn, prozentBtn, wurzelBtn, calcBinom, solveBtn, calcNormal,
				simulationBtn, simulationStopBtn, speakBtn, würfelBtn, baumBtn, grafikrechnerBtn, betterEinheitenBtn};
		}
	...
	private void starteGrafikrechner() {

		JFrame frame = new JFrame("Grafikrechner");

		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		frame.setSize(1200, 800);
		frame.setLocationRelativeTo(this);

		frame.add(new GrafikrechnerPanel());
		...
		private double parseProbability(String s) {
	...
	class GrafikrechnerPanel extends JPanel {
	...
	class GraphPanel extends JPanel {
		...
		private double eval(String f,double x){
			...
			return new SimpleExpressionParser(f).parse();
		}
	}
	class SimpleExpressionParser {
		...
		public SimpleExpressionParser(String s){
			this.s=s;
			next();
		}
